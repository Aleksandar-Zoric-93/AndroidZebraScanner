...
class ReactZebraScanner extends Component {
  constructor(props)
  {
    super(props);
    ...
    DataWedgeIntents.registerReceiver('diomacZebra', '');
  }
...
AppRegistry.registerComponent('ReactZebraScanner', () => ReactZebraScanner);
